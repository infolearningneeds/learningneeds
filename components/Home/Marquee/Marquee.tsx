...
const Marquee = () => {
  return (
    <div className="relative w-full overflow-hidden bg-blue-600 py-4 shadow-lg">
      ...
      <div className="absolute left-0 top-0 bottom-0 w-32 bg-gradient-to-r from-blue-600 to-transparent z-10"></div>
      <div className="absolute right-0 top-0 bottom-0 w-32 bg-gradient-to-l from-blue-600 to-transparent z-10"></div>
